...
<html>
    ...
    <div align="center" id="main_content">
        <h1 align="center"><s:property value="searchHeadingText"></s:property></h1>
        <table width="100%"><tr>
                <td> <p style="color: tomato; padding-left: 5px;" align="left">Total Bills - <s:property value="billList.size()"></s:property></p></td>
                <td><p style="color: tomato; padding-right: 5px;" align="right">Total Amount - <s:property value="totalAmount"></s:property></p></td>
            </tr></table>
    ...
    <table border="0" width="100%" cellpadding="2" cellspacing="2" align="center">
          <tr bgcolor="#e1e2f5">
              ...
              <th  align="center" width="87%">Amount</th>
          </tr>
          ...
          <tr bgcolor="#e1e2f5">
               ...
               <td align="center" width="10%"><s:a href="%{viewSearchBillUrl}"><s:property value="number" /></s:a></td>
               <td align="right" width="3%"><s:property value="billDate" /></td>
               <td align="right" width="87%" ><s:property value="totalAmount" /></td>

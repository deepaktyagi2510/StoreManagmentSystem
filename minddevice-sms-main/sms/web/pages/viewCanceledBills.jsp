...
<html>
    ...
    <table border="0" width="100%" cellpadding="2" cellspacing="2" align="center">
          ...
          <tr bgcolor="#e1e2f5">
               ...
               <td align="center" width="10%"><s:a href="%{viewBillUrl}"><s:property value="number" /></s:a></td>
